/**
 * Pure JavaScript SHA-256 implementation with Web Crypto API acceleration
 * Guarantees zero runtime crashes across all browser security contexts and iframe environments
 */
...
export async function hashPassword(plainText: string): Promise<string> {
  const salted = plainText + '_omnibiz_salt_v1';
  try {
